        ...
        <div class="flex flex-col md:flex-row gap-x-16 my-10">
            <div class="w-full">
                <div class="relative flex justify-center items-center">
                    <NuxtImg src="/bg-post.png" class="w-full object-cover" />
                    <NuxtImg :src="techData?.image" class="sm:h-40 h-28 absolute z-10" />
                </div>
            </div>
            <div class="w-full">
                <div class="flex flex-col">
                    <button @click.prevent="goBack" class="md:flex hidden w-max flex-row items-center hover:scale-110 duration-100">
                        <span class="me-2">
