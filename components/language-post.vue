...
// Deklarasikan `menus` sebagai reaktif
const menus = ref({
  language: false, // Default state menu bahasa (tertutup)
});
...
const changeLanguage = (lang) => {
  setLocale(lang);
  language.value = lang;
  menus.value.language = false; // Tutup dropdown setelah memilih
};

// Fungsi untuk toggle menu bahasa
