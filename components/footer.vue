  ...
  <footer class="bg-sky-200 py-8 px-8 min-[1105px]:px-[133px] md:px-16">
    <div class="flex md:flex-row flex-col mb-7">
      <div class="flex flex-row md:justify-start justify-center items-center gap-x-4">
        <NuxtImg src="/logo-brand.png" alt="logo-brand" class="h-11 object-contain" />
      ...
      <div class="flex flex-row justify-center md:justify-end items-center md:mt-0 mt-7 md:grow grow-0">
        ...
        <NuxtLink to="/about-me" class="px-3 py-2 text-sm mont-semibold text-sky-800">{{ $t("navbar.about") }} </NuxtLink>
        <NuxtLink to="/portfolio" class="px-3 py-2 text-sm mont-semibold text-sky-800">{{ $t("navbar.portfolio") }} </NuxtLink>
        <NuxtLink to="/contact" class="px-3 py-2 text-sm mont-semibold text-sky-800">{{ $t("navbar.contact") }}</NuxtLink>
      </div>
    </div>
