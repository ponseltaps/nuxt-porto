  ...
  <div class="pt-0 min-[1105px]:px-[133px] md:px-16 px-8 mt-2 mb-16">
    <div class="flex md:flex-row flex-col justify-center gap-4 px-4 py-4 border-b-2 border-b-white text-white">
      <button
        ...
        :class="[
          ...
          activeFilter === 'all' ? 'bg-sky-950 text-white' : 'hover:scale-90 hover:text-slate-300 duration-200',
        ]"
      >
        {{ $t("porto.all") }}
      </button>
      <button
        ...
        :class="[
          'md:text-xl text-base popp-bold rounded-2xl px-7 py-2',
          activeFilter === 'web-dev' ? 'bg-sky-950 text-white' : 'hover:scale-90 hover:text-slate-300 duration-200',
        ]"
      >
        {{ $t("porto.wd") }}
      </button>
      <button
        ...
        :class="[
          'md:text-xl text-base popp-bold rounded-2xl px-7 py-2',
          activeFilter === 'ui-des' ? 'bg-sky-950 text-white' : 'hover:scale-90 hover:text-slate-300 duration-200',
        ]"
      >
        {{ $t("porto.ui") }}
      </button>
      <button
        ...
        :class="[
          'md:text-xl text-base popp-bold rounded-2xl px-7 py-2',
          activeFilter === 'graphic-des' ? 'bg-sky-950 text-white' : 'hover:scale-90 hover:text-slate-300 duration-200',
        ]"
      >
        {{ $t("porto.gd") }}
      </button>
    ...
    <div class="mt-14">
      ...
      <div class="grid content-center md:grid-cols-2 grid-cols-1 gap-12 mt-14">
        <div
          v-show="activeFilter === 'all' || activeFilter === 'web-dev'"
        ...
        <div
          v-show="activeFilter === 'all' || activeFilter === 'ui-des'"
          class="flex flex-col items-center justify-center bg-sky-950 rounded-xl px-4 py-6 gap-4"
        >
          <NuxtImg src="/mockup-laptop.png" class="w-44" />
        ...
        <div
          v-show="activeFilter === 'all' || activeFilter === 'graphic-des'"
          class="flex flex-col items-center justify-center bg-sky-950 rounded-xl px-4 py-6 gap-4"
        >
          <NuxtImg src="/mockup-laptop.png" class="w-44" />
