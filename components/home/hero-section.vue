...
<template>
  <div class="md:h-screen lg:pt-0 pt-24 min-[1105px]:px-[133px] md:px-16 px-8 bg-gradient-to-b from-sky-100 via-sky-300 to-sky-500">
    <div class="flex flex-row h-full">
        ...
        <div class="md:flex hidden -mr-10 justify-end items-end md:w-1/2 w-1/4">
          <NuxtImg src="/foto-hero.svg" format="webp" alt="profile-photo" class="hover:hover:-translate-y-4 drop-shadow-md lg:w-[400px] max-[1105px]:w-[300px] md:w-[250px] object-contain transition-transform duration-300" />
        </div>
    </div>
  </div>
</template>